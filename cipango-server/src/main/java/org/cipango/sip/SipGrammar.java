...
public class SipGrammar 
{
	...
	private static final String 
	    ...
	    PASSWD_UNRESERVED = "&=+$,",
	    TOKEN = "-.!%*_+`'~",
		UNRESERVED = ALPHA + DIGITS + MARK,
		USER_UNRESERVED= "&=+$,;?/";

	public static final SipCharset 
		__alpha = new SipCharset(ALPHA),
		__alphaNum = new SipCharset(ALPHA + DIGITS),
		__scheme = new SipCharset(ALPHA + DIGITS + "+-."),
		__token = new SipCharset(ALPHA + DIGITS + TOKEN),
		__lws = new SipCharset(LWS),
