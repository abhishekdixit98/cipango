...
public class ViaTest 
{
	...
	public void testCustomParam() throws Exception
	{
		...
		via.addParameter("custom-param", "custom");
		//System.out.println(via);
	...
	{
		Via via = new Via("SIP/2.0/UDP pc33.atlanta.com;custom-param=\"quoted/ char\"");

		via.setTransport("TCP");
		//System.out.println(via);
		assertEquals("SIP/2.0/TCP pc33.atlanta.com;custom-param=\"quoted/ char\"", via.toString());
	}
